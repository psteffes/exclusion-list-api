"""
Django settings for exclusionlist project.
...
SECRET_KEY = '!qteb9xz$)%n3t@1#gi*bl1(wob82rq7sj2wd_f*uzvwkb+3v5'
...
ROOT_URLCONF = 'exclusionlist.urls'
...
WSGI_APPLICATION = 'exclusionlist.wsgi.application'
